...
# RSpec.describe 'HTML header on different screens' do
...
#         expect(page.find(:xpath, '//html/head/meta[@name="description"]',
#                          visible: false)[:content]).to eq 'Trie Text Analyzer'
#       end
